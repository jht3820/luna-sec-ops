	...
	<div class="kt-portlet__head kt-portlet__head--lg">
		...
		<div class="kt-portlet__head-toolbar">
			<div class="kt-portlet__head-group">
				<button type="button" class="btn btn-outline-brand btn-bold btn-font-sm osl-portlet__head-btn--padding-tablet kt-margin-r-5 btn-elevate btn-elevate-air" data-datatable-id="stm8000RepTable" data-datatable-action="selectedConnect" title="선택 저장소 연결 확인" data-title-lang-cd="stm8000.actionBtn.connectTooltip.select" data-toggle="kt-tooltip" data-skin="brand" data-placement="bottom" data-auth-button="selectedConnect" tabindex="1">
					<i class="fab fa-usb"></i><span data-lang-cd="stm8000.actionBtn.connect.select">선택 접속 확인</span>
				</button>
				<button type="button" class="btn btn-outline-brand btn-bold btn-font-sm osl-portlet__head-btn--padding-tablet kt-margin-r-5 btn-elevate btn-elevate-air" data-datatable-id="stm8000RepTable" data-datatable-action="allConnect" title="전체 저장소 연결 확인" data-title-lang-cd="stm8000.actionBtn.connectTooltip.all" data-toggle="kt-tooltip" data-skin="brand" data-placement="bottom" data-auth-button="allConnect" tabindex="2">
					<i class="fas fa-bezier-curve"></i><span data-lang-cd="stm8000.actionBtn.connect.all">전체 접속 확인</span>
				</button>
				<button type="button" class="btn btn-outline-brand btn-bold btn-font-sm osl-portlet__head-btn--padding-tablet kt-margin-r-5 btn-elevate btn-elevate-air" data-datatable-id="stm8000RepTable" data-datatable-action="select" title="저장소 조회" data-title-lang-cd="stm8000.actionBtn.selectTooltip" data-toggle="kt-tooltip" data-skin="brand" data-placement="bottom" data-auth-button="select" tabindex="3">
					<i class="fa fa-list"></i><span data-lang-cd="datatable.button.select">조회</span>
				</button>
				<button type="button" class="btn btn-outline-brand btn-bold btn-font-sm osl-portlet__head-btn--padding-tablet kt-margin-r-5 btn-elevate btn-elevate-air" data-datatable-id="stm8000RepTable" data-datatable-action="insert" title="저장소 추가" data-title-lang-cd="stm8000.actionBtn.insertTooltip" data-toggle="kt-tooltip" data-skin="brand" data-placement="bottom" data-auth-button="insert" tabindex="4">
					<i class="fa fa-plus"></i><span data-lang-cd="datatable.button.insert">추가</span>
				</button>
				<button type="button" class="btn btn-outline-brand btn-bold btn-font-sm osl-portlet__head-btn--padding-tablet kt-margin-r-5 btn-elevate btn-elevate-air" data-datatable-id="stm8000RepTable" data-datatable-action="update" title="저장소 수정" data-title-lang-cd="stm8000.actionBtn.updateTooltip" data-toggle="kt-tooltip" data-skin="brand" data-placement="bottom" data-auth-button="update" tabindex="5">
					<i class="fa fa-edit"></i><span data-lang-cd="datatable.button.update">수정</span>
				</button>
				<button type="button" class="btn btn-outline-brand btn-bold btn-font-sm osl-portlet__head-btn--padding-tablet btn-elevate btn-elevate-air" data-datatable-id="stm8000RepTable" data-datatable-action="delete" title="저장소 삭제" data-title-lang-cd="stm8000.actionBtn.deleteTooltip" data-toggle="kt-tooltip" data-skin="brand" data-placement="bottom" data-auth-button="delete" tabindex="6">
