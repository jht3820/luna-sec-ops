...
<div class="kt-portlet kt-portlet--mobile" id="stm2200PrjAuthInfo">
	<div class="kt-portlet__head kt-portlet__head--lg">
		<div class="kt-portlet__head-label">
			<h5 class="kt-font-boldest kt-font-brand" id="authGrpContentTitle">
				<i class="fa fa-user kt-margin-r-5"></i><span data-lang-cd="stm2200.title.authGrpList">시스템 권한 그룹</span>
			</h5>
			
			<div class="osl-collapsed__content kt-hide" id="authGrpContentAuthList">
		...
		<div class="kt-portlet__head-toolbar">
			...
			<div class="kt-portlet__head-wrapper kt-margin-r-10" id="authGrpTableBtn">
	...
	<div class="kt-portlet__head kt-portlet__head--lg">
		<div class="kt-portlet__head-label">
			<h5 class="kt-font-boldest kt-font-brand">
				<i class="fa fa-stream kt-margin-r-10"></i><span id="authGrpNameTitle"></span> 
				<span data-lang-cd="stm2200.title.authList">시스템 메뉴 권한</span>
			</h5>
		</div>
		<div class="kt-portlet__head-toolbar">
...
var OSLStm2200 = function () {
	...
	var documentSetting = function () {
		...
		$.osl.datatable.setting("stm2200AuthTable",{
			...
			actionFn:{
				...
				"click":function(rowData){
					...
					var foldingAuthGrpTarget = $("#authGrpContentAuthList").children('ul');
		...
		$("#authFoldingBtn").click(function(){
			var target = $(this).parents('.kt-portlet');
			
			if($(target).hasClass("kt-portlet--collapse")){	 
				$("#authGrpContentTitle").addClass('kt-hide');
				$("#authGrpContentAuthList").removeClass('kt-hide');
				$("#authGrpTableBtn").addClass('kt-hide');	
			}else{
				$("#authGrpContentTitle").removeClass('kt-hide'); 	
				$("#authGrpContentAuthList").addClass('kt-hide'); 
				$("#authGrpTableBtn").removeClass('kt-hide');
			}
		});
	...
	var authListSetting = function() {
		...
		ajaxObj.setFnSuccess(function(data){
			...
			if(data.errorYn == "Y"){
				...
				var target = $("#authGrpContentAuthList").children('ul');
