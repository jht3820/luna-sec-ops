	...
	<div class="col-lg-7 col-md-12 col-sm-12 col-12 kt-margin-t-20-tablet">
		<div class="kt-portlet kt-margin-b-10">
			<div class="kt-portlet__head">
				<div class="kt-portlet__head-label">
					<h5 class="kt-font-boldest kt-font-brand">
						<i class="fa fa-th-large kt-margin-r-5"></i><span id="revisionNum"></span><span data-lang-cd="cmm6800.title.file">파일 목록</span>
					</h5>
				</div>
			</div>
		</div>
...
var OSLCmm6800Popup = function() {
	...
	var treetableId = "cmm6800RevisionFileTreeDiv";
	var treeDatatableId = "cmm6800RevisionFileTable";
		...
		$.osl.datatable.setting(treeDatatableId,{
				...
				actionFn:{
					...
					"detail": function(rowDatas, datatableId, type, rowNum){
						...
						if(type == "list"){
							if(rowNum != 1){
								$.osl.alert($.osl.lang("cmm6800.revisionFile.message.selectOne"));
								return false;
							}else{
								rowData = rowDatas[0];
							}
	...
	var treeContent = function(){
		...
		if($.osl.isNull(revision)){
			...
			$('.osl-div-cover').text($.osl.lang("cmm6800.dirTree.message.selectRevision"));
