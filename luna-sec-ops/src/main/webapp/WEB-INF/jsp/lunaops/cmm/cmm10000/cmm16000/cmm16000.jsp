...
<form class="kt-form" id="frCmm16000">
	...
	<div class="kt-portlet kt-portlet--mobile">
		<div class="kt-portlet__body">
			<div class="col-lg-8 col-md-8 col-sm-12 m-auto kt-margin-t-15">
				<div class="osl-datatable-search" data-datatable-id="cmm16000ReqTable"></div>
			</div>
			<div class="kt-datatable" id="cmm16000ReqTable"></div>
		</div>
	</div>
	<div class="modal-footer">
		<button type="button" class="btn btn-brand" id="cmm16000SaveSubmit"><i class="fa fa-check-square"></i><span data-lang-cd="common.name.select">선택</span></button>
...
var OSLCmm16000Popup = function () {
    ...
    var documentSetting = function () {
		var datatableId = "cmm16000ReqTable";
    	var paramReqNm = $.osl.escapeHtml($("#frCmm16000 > #paramReqNm").val());
    	var paramReqProType = $("#frCmm16000 > #paramReqProType").val();
    	...
    	$("#cmm16000SaveSubmit").click(function(){
    		$.osl.layerPopupClose();
    	});
    };
