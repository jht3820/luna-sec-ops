...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		/* 취소 */
		$('#btnPopCmm1800Cancle').click(function() {
			gfnLayerPopupClose();
		});
		
		$('#btnPopCmm1800Select').click(function() {
			gfnCheckRow(popGrid);
		});
	});
	...
	function fnAxGridSet(){
        ...
        popGrid.setConfig({
            ...
            //frozenColumnIndex: 2,
            columns: [
				{key: "processNm", label: "프로세스명", width: 220, align: "left"},                      
				                  
				{key: "processOrd", label: "프로세스 순서", width: 100, align: "right"}
        ...
        var ajaxParam = "&searchPopTxt=${param.processNm}";
	...
	function fnInGridPopListSet(_pageNo,ajaxParam){
		...
		if(gfnIsNull(ajaxParam)){		
			...
			if("" == ajaxParam){
				ajaxParam += "&searchPopTxt=${param.processNm}";
			}
		}
    	...
    	var data=gfnSelectCmm1800ProcessList(ajaxParam);
		var list = data.list;
...
<div class="popup">
	...
	<div class="pop_title">프로세스 조회</div>
	<div class="pop_sub">
		...
		<div class="btn_div">
			<div class="button_normal save_btn" id="btnPopCmm1800Select" >선택</div>
			<div class="button_normal exit_btn" id="btnPopCmm1800Cancle"  >취소</div>
		</div>
	</div>
	</form>
</div>
