...
<form class="kt-form" id="frPrj1402">
		...
		<div class="col-lg-6 col-md-12 col-sm-12">
			<div class="kt-portlet">
				<div class="kt-portlet__head kt-portlet__head--lg">
					...
					<div class="kt-portlet__head-toolbar">
						<div class="kt-portlet__head-wrapper">
							<button type="button" class="btn btn-outline-brand btn-bold btn-font-sm kt-margin-l-5 kt-margin-r-5 btn-elevate btn-elevate-air" data-datatable-id="prj1402PrjAuthUsrTable" data-datatable-action="select" title="사용자 배정 목록 조회" data-toggle="kt-tooltip" data-skin="brand" data-placement="bottom" data-auth-button="select" tabindex="1">
				...
				<div class="kt-portlet__body osl-min-h-px--400 kt-padding-10">
					<div class="osl-datatable-search" data-datatable-id="prj1402PrjAuthUsrTable"></div>
					<div class="kt_datatable" id="prj1402PrjAuthUsrTable"></div>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="col-lg-12 col-md-12 col-sm-12">
			<div class="kt-portlet">
				...
				<div class="kt-portlet__body kt-padding-10">
					...
					<div class="kt_datatable" id="prj1000PrjTable"></div>
				</div>
			</div>
		</div>
	</div>
