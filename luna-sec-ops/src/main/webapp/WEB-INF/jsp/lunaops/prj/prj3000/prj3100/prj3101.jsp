...
var OSLPrj3101Popup = function () {
	...
	var selectFileList = function(){
		...
		var ajaxObj1 = new $.osl.ajaxRequestAction(
				...
				,{docAtchFileId: atchFileId, docId : docId});
	...
	var drawList = function(data){
		...
		$.each(atchFileList, function(idx, fileData){
			var fileVolume =Math.round($.osl.escapeHtml(fileData.fileSize) / 1024) + ' KB';
			var iconPath = '';
			var iconClass = '';
			var iconColor = '';
	...
	var fileDownBtnEvt = function(){
		...
		$('#frPrj3101 .osl-uppy-list-dashboardItem-action--download').click(function(){
