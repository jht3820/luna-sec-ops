...
<form class="kt-form" id="bad1005Info">
	<div class="kt-portlet kt-portlet--mobile">
		...
		<div class="modal-footer">
			<button type="button" class="btn btn-brand" id="bad1005deleteSubmit">
...
<script>
	...
	var OSLBad1005Popup = function() {
		...
		var documentSetting = function() {
			...
			$("#bad1005deleteSubmit > span").text(
					$.osl.lang("bad1005.button.submit"));
			$(".btn.btn-outline-brand[data-dismiss=modal] > span").text(
					$.osl.lang("modal.close"));
			...
			formEditList.push($.osl.editorSetting("delTxt", {
			...
			$("#bad1005deleteSubmit").click(
					function() {
						delData.delTypeCd = $("#delTypeCd").val();

						
						var delTxt = $("#delTxt").val().replace(
								/(<([^>]+)>)/ig, "").replace(/&nbsp;/g, '')
								.trim();
						;
