...
<div class="kt-portlet kt-portlet--mobile">
	...
	<div class="kt-portlet__body">
		<div class="kt-align-center">
			<span data-lang-cd="req4103.text">잠긴 요구사항입니다. 비밀번호를 입력하세요.</span>
			<div class="input-group kt-margin-t-10">
				...
				<div class="input-group-append">
					<button class="btn btn-brand" name="pwCheckBtn" id="pwCheckBtn" ><span data-lang-cd="req4103.button.submit">확인</span></button>
				</div>
			</div>
		</div>
	</div>
    	...
    	ajaxObj.setFnSuccess(function(data){
    		if(data.errorYn == "Y"){
				...
				if(pwCheck == "Y"){
					...
					$.osl.alert($.osl.lang("req4103.passwordMiss") , {"type" : "warning"});
					$("#reqPwInput").val("");
					$("#reqPwInput").focus;
				}
			}
