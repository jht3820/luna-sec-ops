...
public class Prj3000ServiceImpl extends EgovAbstractServiceImpl implements Prj3000Service {
	...
	public void deletePrj3000DocInfo(Map<String, String> paramMap) throws Exception {
		...
		for (int i = 0; i < jsonArray.size(); i++) {
			...
			for (FileVO fileInfo : formConfFileList) {
				...
				fileMngDAO.deleteAllFileInf(fileInfo);
	...
	@Override
	public void savePrj3003SignInfo(Map<String, String> paramMap) throws Exception {
		...
		if(singUsrInfList != null && !"[]".equals(singUsrInfList)) {
			...
			for(int i=0;i<jsonArray.length();i++) {
				...
				prj3000DAO.insertPrj3003SignInfo(paramMap);
			}
		}
	}
	...
	public int selectPrj3001WaitSignCnt(Map<String, String> paramMap) throws Exception {
		return prj3000DAO.selectPrj3001WaitSignCnt(paramMap);
	}
